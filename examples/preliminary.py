...
filenames = os.listdir("spreadsheets")
score1 = []
score2 = []
score3 = []
score4 = []
...
for filename in filenames:
    ...
    sup = SupervisedAreasOfInterest.from_labelled_img("NEW tower Image AOIs.png", track)
...
pd.DataFrame({"File": filenames, "Score1": score1, "Score2": score2, "Score3": score3, "Score4": score4, "Score5": score5}).to_csv(os.path.join(outdir, "main.csv"))